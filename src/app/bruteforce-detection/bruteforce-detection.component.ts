...
@Component({
  selector: 'app-bruteforce-detection',
  templateUrl: './bruteforce-detection.component.html',
  styleUrls: ['./bruteforce-detection.component.css']
})
export class BruteforceDetectionComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    if (analyzeElement) {
      analyzeElement.addEventListener('click', () => {
        window.location.href = '/alert-brute'; 
      });
    }
  }
